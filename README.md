...
The system is optimized to deal with the issue of hallucinations that the LLMs are infamous for. It also demonstrates on how efficient prompt engineering can help utilise the power of Large Language Models even with a small context window of 8k or 16k tokens. **(Screen Recording at the bottom)**
